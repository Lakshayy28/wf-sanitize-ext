 ...
 */
function expandPemRegion(text: string, region: { start: number; end: number }): void {
  ...
  if (absoluteBegin > region.start) { return; } // BEGIN is after region start — not enclosing
