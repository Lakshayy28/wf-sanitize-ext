...
export type SupportedLang = 'json' | 'yaml' | 'toml';
...
const grammarCache = new Map<SupportedLang, import('web-tree-sitter').Language>();
 ...
 */
async function loadGrammar(lang: SupportedLang): Promise<import('web-tree-sitter').Language> {
